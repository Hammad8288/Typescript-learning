...
let locations:string[] = ['skardu','malam jabba','kashmir','manshera','lahore'] ;
...
let reverse_alpha_order:string[] = [...locations].sort().reverse() ;
console.log(`reverse_alpha_order : ${reverse_alpha_order}`)
console.log(`original order : ${locations} `) ;

//• Reverse the order of your list. Print the array to show that its order has changed.
let reverse_order:string[] = [...locations].reverse() ;
